  ...
  <div className='taas-main-content'>
    <div className='taas-content'>
      <div className='taas-header'>
          ...
          <img src="../assets/TAAS Graphic.png" alt="Requestify" />
      </div>
      <div className='taas-desc-container'>
        ...
        <div className='taas-desc'>
          ...
          <img src="../assets/Student lofi.png" alt="student lofi" className='student-lofi-graphic'/>
          ...
          <img src="../assets/Prof lofi.png" alt="prof lofi" className='prof-lofi-graphic'/>
          ...
          <img src="../assets/Manager lofi.png" alt="manager lofi" className='manager-lofi-graphic'/>
        ...
        <div className='taas-desc prototype-taas-desc'>
          ...
          <img src="../assets/Student 1.png" alt="student 1"/>
          <img src="../assets/Student 2.png" alt="student 2"/>
          ...
          <img src="../assets/Prof 1.png" alt="prof 1"/>
          <img src="../assets/Prof 2.png" alt="prof 2"/>
          ...
          <img src="../assets/Manager 1.png" alt="manager 1"/>
          <img src="../assets/Manager 2.png" alt="manager 2"/>
          <img src="../assets/Manager 3.png" alt="manager 3"/>
        ...
        <div className='taas-desc'>
          ...
          <img src="../assets/Graphs.png" alt="Graph" className='graph-graphic'/>
